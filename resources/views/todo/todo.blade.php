...
<div class="header-navs">
    ...
    <div class="settings-menu__container" style="background-color:lightgray;">
        ...
        <!-- 設定メニューの一覧リスト -->
        <ul id="settingsMenu" class="settings-menu" style="display:none">
            @if(Auth::check())
    ...
    <div class="search-menu_container" style="background-color:lightgray;">
        ...
        <form id="searchForm" action="{{ route('todo.search') }}" class="search-menu__form hidden" method="post">
            @csrf
            <input id="searchFormText" class="search-menu__text padding-5" type="text" name="text" value="{{ old('text') }}" placeholder="タスクを検索">
    ...
    <div class="main-menu__container" style="background-color:lightgray;">
            ...
            <!-- メインメニューの一覧リスト -->
            <ul id="mainMenu" class="main-menu" style="display:none">
...
<form action="{{ route('todo.deleteMultiple') }}" method="post">
    ...
    <!-- 今日のタスク -->
    <div id="tasks-today" class="tasks-list" style="display:none">
...
@section('footer')
    <!-- 削除ボタン -->
    <button id="DeleteBtn" class="tasks-delete__btn" style="display:none">
    ...
    <!-- /削除ボタン -->
     <!-- 追加ボタン -->
    <button id="toggleFormBtn" class="tasks-add__btn" style="display:none">
        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24">
    ...
    <!-- タスクの追加フォーム -->
    <div id="inputFormContainer" class="tasks-add-form__container" style="display:none">
    @include('todo.create')
    </div>
    <!-- /タスクの追加フォーム -->
